...
function cambiar() {
  ...
  if (butom_idioma.value === "Ingles") {
    ...
    let escusa =
      lengujues.Ingles.who[whonr] +
      " " +
      lengujues.Ingles.action[actionnr] +
      " " +
      lengujues.Ingles.what[whatnr] +
      " " +
      lengujues.Ingles.when[whennr];
    return escusa;
    ...
    let escusa =
      lengujues.Español.quien[quiennr] +
      " " +
      lengujues.Español.accion[accionnr] +
      " " +
      lengujues.Español.que[quenr] +
      " " +
      lengujues.Español.cuando[cuandonr];
